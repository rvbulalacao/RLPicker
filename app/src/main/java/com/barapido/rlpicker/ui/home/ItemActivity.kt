...
class ItemActivity : AppCompatActivity() {
    ...
    private fun displayItem() {
        ...
        qtyPicked.setText(item.getInt("unconfirmed_picked_qty").toString())
        qtyOrdered.text = item.getInt("qty").toString()
    }
    ...
    fun confirm(view: View) {
        ...
        try {
            ...
            var req = object: JsonObjectRequest(
                Request.Method.PUT, Rubian.BASE_URL + route, JSONObject("{'unconfirmed_picked_qty': ${qtyPickedVal}}"), {   it
                    finish()
                },
